...
# Добавляем папку 'code' в путь поиска
import os
code_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'code')
sys.path.insert(0, r"C:\Users\Mixa\Desktop\UP.01\UP_02_Algorithms_Practice\code")
...
def run_trees_graphs():
    ...
    try:
        ...
        from trees_graphs.advanced_trie import test_advanced_trie
